...
#### Calculating (modified) SWPER index

```{r echo = FALSE, results = 'asis'}
library(knitr)
indicator = c("Beating not justified if wife goes out without telling husband", "Beating not justified if wife neglects the children", "Beating not justified if wife argues with husband", "Beating not justified if wife refuses to have sex with husband", "Beating not justified if wife burns the food", )
kable()
```



Official components and whether they're present (note, representative values will have to be modified):

 | Justified=–1; don’t know=0; not justified =1 | PRESENT
d=–1; don’t know=0; not justified=1

...
#  geom_point()+
  ...
  labs(title = "Poverty Probability and Food Insecurity by Group Membership", x = "Probability Household Is Not in Poverty", y = "Level of Food Security (Reverse FIES Score)")+
